                ...
                <div class="experience-grid">
                  ...
                  <div class="experience-card">
                    ...
                    <ul class="experience-list">
                      ...
                      <li>Built marketing workflows using trigger-based segmentation and lead scoring criteria, increasing email engagement by 12% and cutting time-to-first-touch by 24 hours.</li>
                    </ul>
                  </div>
                </div>
              </div>
